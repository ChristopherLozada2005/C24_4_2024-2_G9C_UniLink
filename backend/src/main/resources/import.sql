...
INSERT INTO publicaciones(titulo, descripcion, categoria, fecha_publicacion, usuario_id, tiene_imagen, imagen_url) VALUES('Proyecto de Software', 'Desarrollo de un sistema de gestión para pequeñas empresas', 'Curricular', CURRENT_TIMESTAMP, 1, 'yes', 'https://res.cloudinary.com/dade42bjv/image/upload/q_auto,f_auto,w_800/feed1.jpg');
INSERT INTO publicaciones(titulo, descripcion, categoria, fecha_publicacion, usuario_id, tiene_imagen, imagen_url) VALUES('Evento de Capacitación', 'Organización de un taller sobre producción industrial sostenible', 'Extracurricular', CURRENT_TIMESTAMP, 2, 'yes', 'https://res.cloudinary.com/dade42bjv/image/upload/q_auto,f_auto,w_800/feed2.jpg');
INSERT INTO publicaciones(titulo, descripcion, categoria, fecha_publicacion, usuario_id, tiene_imagen, imagen_url) VALUES('Aplicación Web Innovadora', 'Creación de una plataforma web para gestión educativa', 'Curricular', CURRENT_TIMESTAMP, 3, 'yes', 'https://res.cloudinary.com/dade42bjv/image/upload/q_auto,f_auto,w_800/feed3.jpg');
INSERT INTO publicaciones(titulo, descripcion, categoria, fecha_publicacion, usuario_id, tiene_imagen, imagen_url) VALUES('Conferencia de Seguridad', 'Participación como ponente en una conferencia de ciberseguridad', 'Extracurricular', CURRENT_TIMESTAMP, 4, 'yes', 'https://res.cloudinary.com/dade42bjv/image/upload/q_auto,f_auto,w_800/feed4.jpg');
